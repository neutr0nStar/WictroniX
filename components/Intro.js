...
export default function Intro() {
  ...
  React.useEffect(() => {
    ...
    var S = {
      init: function () {
        ...
        // if (sessionStorage.getItem("wxLoaded")) {
        //   S.UI.simulate("WictroniX");
        // } else {
    ...
    S.Drawing = (function () {
      ...
      return {
        ...
        drawCircle: function (p, c) {
          ...
          context.beginPath();
          context.arc(p.x, p.y, p.z / (isMobile ? 5 : 2), 0, 2 * Math.PI, true);
          context.closePath();
          context.fill();
        },
      };
    ...
    S.ShapeBuilder = (function () {
      var gap = window.innerWidth < window.innerHeight ? 5 : 7,
      ...
      function setFontSize(s) {
        shapeContext.font = "bold small-caps " + s + "px " + fontFamily;
      }
        ...
        letter: function (l) {
          ...
          s = Math.min(
            ...
            (shapeCanvas.width / shapeContext.measureText(l).width) *
              (window.innerWidth < window.innerHeight ? 0.9 : 0.8) *
              fontSize,
  ...
  return (
    <div>
      <canvas ref={canvasRef} id="canvas" className={styles.root} />
    </div>
  );
}
