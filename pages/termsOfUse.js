...
export default function termsOfUse() {
  return (
    <div>
      <Head>
        <title>Terms of Use - WictroniX</title>
        <meta name="description" content="WictroniX Terms of Use" />
        <meta
          name="keywords"
     ...
     Web developers near me, Web Development, Content Writing, Graphic Designers, Photo Editing, Business Planning, SEO, WordPress Management, Cloud Management, Logo Designing"
      ...
      <div style={{ marginInline: "1rem" }}>
        ...
        <p>Version 1.0</p>
        <p>
          The WictroniX website located at https://www.wictronix.com/ is a
          copyrighted work belonging to WictroniX. Certain features of the Site
        ...
        <p>
          ...
          the Company should be sent to: Vadodara ,Gujarat. After the Notice is
        ...
        <p>
          ...
          AND THE COMPANY WAIVE ALL RIGHTS TO A JURY TRIAL, instead electing
        ...
        <p>Address: Vadodara ,Gujarat</p>
        <p>Email: info@wictronix.com</p>
      </div>
    </div>
  );
}
