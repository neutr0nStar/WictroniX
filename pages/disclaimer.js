...
export default function disclaimer() {
  return (
    <div style={{ marginInline: "1rem" }}>
      <h1>Disclaimer for WictroniX</h1>

      <p>
        If you require any more information or have any questions about our site
        &apos;s disclaimer, please feel free to contact us by email at
        info@thewizards.me. Our Disclaimer was generated with the help of the{" "}
        <a href="https://www.termsfeed.com/disclaimer-generator/">
          Disclaimer Generator
        </a>
        .
      </p>

      <h2>Disclaimers for WictroniX</h2>

      <p>
        All the information on this website - https://www.wictronix.com/ - is
        published in good faith and for general information purpose only.
        WictroniX does not make any warranties about the completeness,
        reliability and accuracy of this information. Any action you take upon
        the information you find on this website (WictroniX), is strictly at
        your own risk. WictroniX will not be liable for any losses and/or
